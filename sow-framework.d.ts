...
declare interface IHotTable {
	...
	create(pageCtx: IPageContext, $element: JQuery<HTMLElement>, containerWidth: number, settings: import('handsontable').default.GridSettings, minLength: number): XHandsontable;
}
